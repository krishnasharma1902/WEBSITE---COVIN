  ...
  <script>
    ...
    function scroll_btn(){
             ...
             window.addEventListener("scroll", () => {
              if(window.pageY0ffset >100){
                totop.idList.add("mybtn");
              }
              else{
                totop.idList.remove("mybtn");
              }
             })
    }
  </script>  -->
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark nav_style p-2">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto pr-5">
        ...
        <!-- </li>
           <li class="nav-item">
          <a class="nav-link" href="#contactid">About Vaccination</a>
        </li> -->
        <li class="nav-item">
  ...
  <section class="corona-update container-fluid">
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped text-center" id="tbval">
        ...
        <!-- php code for live count using api-->
        ...
        <div class="col-lg-8 offset-lg-2 col-12">
          <form action="corona.php" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="mobile" placeholder="mobile number" autocomplete="off" required>
            </div>
...
<!--     <p class="fa fa-arrow-up" id="mybtn" ></p> -->
